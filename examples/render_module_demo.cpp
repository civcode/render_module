...
int main() {
    if (!RenderModule::Init(980, 720)) return 1;
    ...
    RenderModule::RegisterImGuiCallback([]() {
        ...
        ImGui::Begin("Control Window", nullptr, ImGuiWindowFlags_MenuBar);
    ...
    RenderModule::RegisterNanoVGCallback("NanoVG Canvas", [](NVGcontext* vg) {
        ...
        // Background for this canvas only.
        // glad::glClearColor(1.0f, 1.0f, 1.0f, 1.0f);
        // glad::glClear(
        //     GL_COLOR_BUFFER_BIT |
    ...
    RenderModule::RegisterNanoVGCallback("NanoVG Canvas 3", [](NVGcontext*) {
    ...
    RenderModule::RegisterNanoVGCallback("Zoomable NanoVG", [](NVGcontext*) {
        RenderModule::ZoomView([](NVGcontext* vg) {
            nvg::SetContext(vg);
            nvg::BeginPath();
    ...
    RenderModule::RegisterNanoVGCallback("Struct NanoVG", [](NVGcontext*) {
        RenderModule::ZoomView([](NVGcontext* vg) {
            nvg::SetContext(vg);
            nvg::BeginPath();
            nvg::MoveTo(0, 0);
