...
void DestroyFBO(PaintWindow& window) {
...
bool CreateFBO(PaintWindow& window, int pixelWidth, int pixelHeight) {
    DestroyFBO(window);
    ...
    // NanoVG's stencil strokes require a stencil attachment on custom FBOs.
