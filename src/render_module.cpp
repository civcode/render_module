...
void RenderModule::RegisterImageView(
    ...
    RegisterImageView(
        name,
        [source = std::move(source)] { return source->Get(); },
        std::move(overlayCallback),
        options);
}
